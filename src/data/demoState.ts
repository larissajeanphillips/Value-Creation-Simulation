...
const MOCK_RISKY: RiskyEventState = {
  triggeredEvents: {},
  activeEventIndex: 0,
};
...
function makeGameState(
  ...
  return {
    ...
    riskyEvents: MOCK_RISKY,
    teamCount,
  };
}

/** Minimal decision for demo decision screen (one per category). */
function makeMockDecisions(): Decision[] {
  return [
    ...
    },
    {
      ...
      narrative: 'Improve margins through efficiency.',
      cost: 50,
      impactMagnitude: 2,
      introducedYear: 1,
      type: 'organic',
      guidingPrinciple: 'Efficiency',
      isRisky: false,
      durationYears: 1,
      rampUpYears: 1,
      isOneTimeBenefit: false,
    ...
    },
    {
      ...
      narrative: 'Maintain operations and reduce risk.',
      cost: 30,
      impactMagnitude: 2,
      introducedYear: 1,
      type: 'organic',
      guidingPrinciple: 'Resilience',
      isRisky: false,
      durationYears: 1,
      rampUpYears: 1,
      isOneTimeBenefit: false,
